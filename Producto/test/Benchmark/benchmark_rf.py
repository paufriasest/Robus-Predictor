...
# 3. Entrenamiento del Modelo y Medición de Tiempo
...
# 4. Predicción
y_pred = modelo_rf.predict(X_valid)
end_time = time.perf_counter()
execution_time = end_time - start_time

VALIDACION['PREDICCION_RF'] = y_pred
...
# 7. Reporte de Resultados (Formato solicitado)
print("-" * 50)
