...
# n_jobs=-1 utiliza toda la potencia de tu procesador/servidor
...
# 4. Predicción
y_pred = modelo_et.predict(X_valid)
end_time = time.perf_counter()
execution_time = end_time - start_time

VALIDACION['PREDICCION_ET'] = y_pred
...
# 7. Reporte de Resultados (Estructura Solicitada)
print("-" * 50)
